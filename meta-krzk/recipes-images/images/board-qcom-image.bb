...
SUMMARY = "Small image capable of booting a device and testing it (for Qcom boards)"
LICENSE = "MIT"

IMAGE_INSTALL = "\
    packagegroup-core-boot \
    packagegroup-board-qcom \
    packagegroup-board-qcom-firmware \
...
# No need for kernel image or kernel modules in the image, so remove the
